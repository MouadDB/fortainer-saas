...
const env = {
  ...
  nodeFeatures: {
    sso: process.env.FEATURE_NODE_SSO === 'false' ? false : true,
    dsync: process.env.FEATURE_NODE_DSYNC === 'false' ? false : true,
    webhook: process.env.FEATURE_NODE_WEBHOOK === 'false' ? false : true,
    apiKey: process.env.FEATURE_NODE_API_KEY === 'false' ? false : true,
    auditLog: process.env.FEATURE_NODE_AUDIT_LOG === 'false' ? false : true,
    deleteNode: process.env.FEATURE_NODE_DELETION === 'false' ? false : true,
  },
