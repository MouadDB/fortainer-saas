...
import type { Invitation, Node } from '@prisma/client';
...
const InviteMember = ({
  ...
  const { mutateInvitation } = useInvitations(node.slug);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const response = await fetch(`/api/nodes/${node.slug}/invitations`, {
        method: 'POST',
